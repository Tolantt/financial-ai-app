...
export default function NotFound() {
  return (
    <section
      ...
      data-track-view="page_404"
    >
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden" aria-hidden="true">
        <div className="absolute left-[22%] top-8 h-56 w-56 rounded-full bg-[#61DAFB]/18 blur-3xl" />
        <div className="absolute right-[18%] bottom-8 h-60 w-60 rounded-full bg-[#21A1F1]/22 blur-3xl" />
      </div>
      <div className="relative w-full max-w-3xl overflow-hidden rounded-[32px] border border-slate-200/60 bg-white/70 px-8 py-14 text-center shadow-[0_24px_60px_rgba(6,10,32,0.45)] backdrop-blur-2xl transition-colors duration-300 dark:border-white/10 dark:bg-white/5">
        ...
        <h1 className="mt-6 text-3xl font-bold text-slate-900 dark:text-white">页面未找到</h1>
        <p className="mt-4 text-base leading-relaxed text-slate-600/90 dark:text-white/70">你访问的地址不存在，返回首页试试吧。</p>
        <Link
          to="/"
