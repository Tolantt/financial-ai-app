...
export default function Assistant() {
  return (
    <section className="py-12 min-h-[60vh] grid place-items-center" data-track-view="page_assistant">
      <div className="text-center max-w-2xl">
        <h1 className="text-3xl font-bold mb-2">金融AI助手</h1>
        ...
        <Link
          ...
          data-track="cta" data-track-action="click" data-track-label="back_home_from_assistant"
        >
          返回首页
        </Link>
      </div>
