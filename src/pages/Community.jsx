...
export default function Community() {
  return (
    <section className="py-12 min-h-[60vh] grid place-items-center" data-track-view="page_community">
      <div className="text-center max-w-2xl">
        ...
        <Link
          ...
          data-track="cta" data-track-action="click" data-track-label="back_home_from_community"
        >
          返回首页
        </Link>
      </div>
