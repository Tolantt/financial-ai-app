...
export default function Quant() {
  return (
    <section
      ...
      data-track-view="page_quant"
    >
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden" aria-hidden="true">
        <div className="absolute left-[20%] top-12 h-56 w-56 rounded-full bg-[#61DAFB]/18 blur-3xl" />
        <div className="absolute right-[20%] bottom-12 h-64 w-64 rounded-full bg-[#21A1F1]/22 blur-3xl" />
      </div>
      <div className="relative w-full max-w-3xl overflow-hidden rounded-[32px] border border-slate-200/60 bg-white/70 px-8 py-14 text-center shadow-[0_24px_60px_rgba(6,10,32,0.45)] backdrop-blur-2xl transition-colors duration-300 dark:border-white/10 dark:bg-white/5">
        ...
        <h1 className="mt-6 text-3xl font-bold text-slate-900 dark:text-white">
          <span className="relative inline-flex items-center gap-3 overflow-hidden rounded-[28px] px-6 py-3 text-white shadow-[0_18px_44px_rgba(251,113,133,0.42)]">
            <span className="absolute inset-0 bg-gradient-to-r from-[#f97316] via-[#fb7185] to-[#f472b6]" aria-hidden="true" />
            <span className="absolute inset-0 blur-xl bg-[#fb7185]/45" aria-hidden="true" />
            <span
              aria-hidden="true"
            ...
            <span className="relative text-2xl font-semibold tracking-wide">量化策略</span>
          </span>
        </h1>
