              ...
              <Route
                ...
                element={
                  <div className="w-full space-y-20 pb-24">
                    ...
                    <section
                      id="assistant"
                      className="w-full space-y-6 px-4 md:px-6 lg:px-10 xl:px-16"
                      aria-label="AI 助手演示"
                    ...
                    <section
                      ...
                      className="relative w-full px-4 md:px-6 lg:px-10 xl:px-16"
                    >
                      <div className="relative overflow-hidden rounded-[28px] border border-slate-200/60 bg-white/70 px-8 py-10 shadow-[0_24px_60px_rgba(6,10,32,0.4)] backdrop-blur-2xl transition-colors duration-300 dark:border-white/10 dark:bg-white/5">
